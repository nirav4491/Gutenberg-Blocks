...
?>
  <style amp-custom>
   header.amp-wp-header.amp-head-top {
        background: #222;
    }
    .head-wrap {
    display: block;
...
.amp-wp-header.amp-head-top .ampstart-navbar-trigger {
...
<header id="top" class="amp-wp-header amp-head-top">
	<div class="head-wrap">
        <div role="button" on="tap:header-sidebar.toggle" tabindex="0" class="ampstart-navbar-trigger">☰</div>
		<a class="logo-anchor" href="<?php echo esc_url( $this->get( 'home_url' ) ); ?>">
			<amp-img src="/wp-content/uploads/2019/12/perfin.svg" width="175" height="30" class="logo"></amp-img>
		</a>
	</div>
</header>
<!-- Start Sidebar -->
